...
parser = argparse.ArgumentParser(description='MSRNet for Time Series Forecasting')
...
parser.add_argument('--num_nodes', type=int, default=3, help='to create Graph')
...
parser.add_argument('--propalpha', type=float, default=0.2, help='')
...
parser.add_argument('--target_num', type=int, default=1, help='Number of target variables')
...
parser.add_argument('--wo_conv', action='store_true', default=True, help='without convolution')
...
parser.add_argument('--patch_len', type=int, nargs='+', default=[16, 8, 4], help='patch high')
parser.add_argument('--period', type=int, nargs='+', default=[24, 16, 8], help='period list') # [24, 16, 12, 8, 4]
parser.add_argument('--scale_weight', type=int, nargs='+', default=[0.3, 0.3, 0.3], help='scale_weight list')
